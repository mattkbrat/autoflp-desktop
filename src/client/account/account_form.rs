...
pub fn AccountForm(cx: Scope) -> Element {
    ...
    render!(
        ...
        form {
                ...
                label { class: "flex flex-col",
                    "First Name"
                    input { name: "first", class: "uppercase", r#type: "text", value: "{person.first_name}" }
                },
                label { class: "flex flex-col",
                    "Middle Initial"
                    input { class: "uppercase", name: "middle", r#type: "text", value: "{middle_initial}" }
                },
                label { class: "flex flex-col",
                    "Last Name"
                    input { name: "last", class: "uppercase", r#type: "text", value: "{person.last_name}" }
                },
                label { class: "flex flex-col", "Suffix", input { name: "suffix", class: "uppercase", r#type: "text", value: "{suffix}" }},

                // Full-width label
                label { class: "flex flex-col col-span-full", "Address (L1)", input { name: "address_1" , class: "uppercase", r#type: "text", value: "{person.address_1}" }},

                div {
                    class: "col-span-full grid grid-cols-2 gap-4",
                    label { class: "flex flex-col", "Address (L2)", input { name: "address_2", class: "uppercase", r#type: "text", value: "{address_2}" }},
                    label { class: "flex flex-col", "Address (L3)", input { name: "address_3", class: "uppercase", r#type: "text", value: "{address_3}" }},
                },

                div {
                    class: "col-span-full grid grid-cols-2 gap-4",
                    div { class: "grid grid-cols-2 gap-2",
                        label { class: "flex flex-col", "City", input { name: "city", class: "uppercase", r#type: "text", value: "{person.city}" }},
                        label { class: "flex flex-col", "State", input { name: "state", class: "uppercase", r#type: "text", value: "{person.state_province}" }},
                    },
                    div { class: "flex col-span-1 gap-2",
                        label { class: "flex flex-col flex-1", "Zip", input { name: "zip", class: "uppercase w-full", r#type: "text", value: "{person.zip_postal}" }},
                        label { class: "flex flex-col", "+4", input { name: "zip_4", class: "uppercase w-16", r#type: "text", value: "{zip_4}" }},
                    },
                },
                div {
                    class: "col-span-full grid grid-cols-3 gap-4",
                    label { class: "flex flex-col ", "Primary Phone" input { name: "phone_primary", class: "uppercase", r#type: "text", value: "{person.phone_primary}" }},
                    label { class: "flex flex-col ", "Secondary Phone" input { name: "phone_secondary", class: "uppercase", r#type: "text", value: "{phone_secondary}" }},
                    label { class: "flex flex-col ", "Tertiary Phone" input { name: "phone_tertiary", class: "uppercase", r#type: "text", value: "{phone_tertiary}" }},
                },
                            div {
                    class: "col-span-full grid grid-cols-2 gap-4",
                label { class: "flex flex-col ", "Primary Email" input { name: "email_primary", class: "uppercase" , r#type: "email", value: "{email_primary}" }},
                label { class: "flex flex-col ", "Secondary Email" input { name: "email_secondary", class: "uppercase", r#type: "email", value: "{email_secondary}" }},
                    },
